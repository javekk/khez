...
const int pstKnightMg[64] = {
    ...
    -38, -16, 10,  14,  8,   3,   3,   -42,  //
    -14, 0,   2,   13,  19,  12,  33,  -7,   //
    -14, -4,  25,  33,  10,  33,  14,  43,   //
    -22, 18,  100, 64,  124, 143, 55,  -6,   //
    -34, 24,  54,  74,  60,  74,  2,   -9,   //
...
const int pstBishopEg[64] = {
    ...
    -1,  -4, 0,  2,  2,  0,  -4, -10,  //
    -2,  8,  12, 14, 14, 12, 8,  -2,   //
    -1,  17, 21, 23, 23, 21, 17, -11,  //
    -1,  20, 24, 26, 26, 24, 20, -14,  //
    -1,  19, 23, 25, 25, 23, 19, -13,  //
